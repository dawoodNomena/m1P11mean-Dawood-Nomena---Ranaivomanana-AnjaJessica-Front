...
@Component({
    ...
    standalone: true,
    templateUrl: './details_rdv.component.html',
    styleUrls: ['./details_rdv.component.scss','./style.css','./style2.css'],
    imports: [CommonModule, SharedModule,NgxPaginationModule, RouterModule]
})
